        ...
        <Row>
            ...
            <Row className="item-center header-postCard pb-3">
                ...
                <div className="ml-3">
                    ...
                    <span className="ml-1 small"><Translate id="headerPost.no1">đã chia sẻ một</Translate></span>
                    <span className="ml-1">
                    <b>
                        {this.props.type === "PLACE" ? (
                        <span className="tcl-2"><Translate id="headerPost.address">Địa điểm</Translate></span>
                        ) : this.props.type === "DONATION" ? (
                        <span className="tcl-3"><Translate id="headerPost.donation">Quyên góp</Translate></span>
                        ) : this.props.type === "EVENT" ? (
                        <span>
                            
                        <span className="tcl-1 mr-2"><Translate id="headerPost.event">Sự kiện</Translate></span>
                        ...
                        <span className="tcl-4"><Translate id="headerPost.memory">Kỉ niệm</Translate></span>
                        )}
                    </b>
            ...
            <div className="menu-post">
                ...
                <Modal isOpen="true" toggle={this.toggleReport}>
                    ...
                    <Translate id="headerPost.reportPost">Báo cáo bài viết</Translate>
                    </ModalHeader>
                    <ModalBody>
                    <Input
                        type="textarea"
                    ...
                    >
                        <i className="fas fa-bug icon-button" /> <Translate id="headerPost.report">Báo cáo</Translate>
                    </Button>
                    <Button
                        color="success"
                        className="mr-1"
                    ...
                    >
                        <i className="fas fa-trash icon-button" /> <Translate id="headerPost.cancel">Hủy</Translate>
                    </Button>
                    </ModalFooter>
                </Modal>
                )}
