    ...
    render() {
        ...
        <div>
            ...
            <Row className="item-mid">
                ...
                <div className="item-center">
                    ...
                    <div className="item-row">
                        <div>
                           <Translate id="leftSide.header">{permissionArr[this.props.permission]}</Translate>
                        <span className="ml-2 tcl-1">
                            <Translate id="leftSide.level">Cấp</Translate> {this.props.exp}
                        </span>
                        </div>
                    </div>
                    </div>
            ...
            <Row>
                ...
                <ul className="list">
                    ...
                    <NavLink exact activeClassName="NavLink--active" to="/medal">
                        <i className="fas fa-medal" /><Translate id="leftSide.award"> Danh hiệu</Translate>
                    </NavLink>
                    </li>
                </ul>
                </Col>
            ...
            <Row>
                <Col>
                <div className="text-title-2 title-left-side p-1">
                    <strong><Translate id="leftSide.community">CỘNG ĐỒNG</Translate></strong>
                </div>
                </Col>
            </Row>
            <Row>
                ...
                <ul className="list">
                    ...
                    <NavLink exact activeClassName="NavLink--active" to="/">
                        <i className="fas fa-home" /><Translate id="leftSide.homepage">Trang chủ</Translate>
                    </NavLink>
                    </li>
                    <li>
                    <NavLink exact activeClassName="NavLink--active" to="/rank">
                        <i className="fas fa-trophy" /><Translate id="leftSide.ranking">Xếp hạng</Translate>
                    </NavLink>
                    </li>
                    <li>
                    <NavLink exact activeClassName="NavLink--active" to="/checkin">
                        <i className="fas fa-calendar-check"/><Translate id="leftSide.monitoring">Điểm danh</Translate>
                    </NavLink>
                    </li>
                </ul>
                </Col>
