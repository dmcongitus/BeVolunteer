...
class EditEvent extends Component {
    constructor(props) {
        ...
        this.props.addTranslation(editEventTranslations);
    }
                ...
                <div className="event-form w-100 text-lg font-bold border-b border-solid border-grey-light">
                    ...
                    <Row className="Row1" style={{ width: "100%" }}>
                        ...
                        <Col>
                            {/* Tên sự kiện */}
                            <FormGroup row>
                            <Label sm={4}> <Translate id="editEvent.status">Trạng thái</Translate></Label>
                            ...
                            <FormGroup row>
                                ...
                                >
                                    <Translate id="editEvent.startNow">Bắt đầu ngay</Translate>
                                </Button>
                                </Col>
                            </FormGroup>
                            ) : null}
                            ...
                            <FormGroup row>
                            <Label sm={4}> <Translate id="editEvent.eventName">Tên sự kiện</Translate></Label>
                            ...
                            {/* Tổ chức */}
                            <FormGroup row>
                            <Label sm={4}><Translate id="editEvent.org">Tổ chức</Translate></Label>
                            ...
                            {/* Địa điểm */}
                            <FormGroup row>
                            <Label sm={4}><Translate id="editEvent.address">Địa điểm</Translate></Label>
                    ...
                    <Form>
                        ...
                        <Label><Translate id="editEvent.sharer">Chia sẻ</Translate></Label>
                        <Select
                            name="sharer"
                        ...
                        <FormGroup className="ml-4 pl-1">
                        <Label> <Translate id="editEvent.description">Nội dung</Translate></Label>
                        <Input
                            onChange={this.onFieldChanged}
                            type="textarea"
                            name="description"
                        ...
                        {/* Thời gian diễn ra */}
                        <FormGroup className="ml-4 pl-1">
                        <Label> <Translate id="editEvent.time">Thời gian diễn ra</Translate></Label>
                        <Row>
                            <Col xs="6">
                            <Input
                                id="starttime"
                        ...
                        {/* Hạn chót đăng kí */}
                        <FormGroup className="ml-4 pl-1">
                        <Label> <Translate id="editEvent.deadline">Hạn chót đăng kí</Translate></Label>
                        <Row>
                            <Col xs="6">
                            <Input
                                id="deadline"
                        ...
                        {/* Liên hệ */}
                        <FormGroup className="ml-4 pl-1">
                        <Label> <Translate id="editEvent.contact">Liên hệ</Translate></Label>
                        <Input
                            onChange={this.onFieldChanged}
                        ...
                        <FormGroup className="ml-4 pl-1">
                        <Label> <Translate id="editEvent.numVolunteer">Số lượng TNV</Translate></Label>
                        <Input
                            onChange={this.onFieldChanged}
            ...
            <div style={{ marginTop: "1.3rem" }} className="widget-sidebar">
                ...
                <Row>
                    ...
                    <div className="btnEvent">
                       ...
                       <Translate id="editEvent.update"> Cập nhật</Translate>
                        </Button>
                        {/* </Link> */}
                    </div>
                    </Col>
