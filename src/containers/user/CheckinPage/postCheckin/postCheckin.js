...
class PostCheckin extends React.Component {
    constructor(props) {
        ...
        this.props.addTranslation(postCheckInPageTranslations);
                        ...
                        <div className="item-right">
                            {this.props.type === "EVENT" && (
                                <div>
                                    <Button className="mr-1 new-btn" onClick={this.toggleCheckin}
                                        ...
                                        <Translate id="postCheckIn.title">Điểm danh</Translate>
                                    </Button>
                                    ...
                                    >
                                        ...
                                        >
                                            <i className="far fa-calendar-check" /> <Translate id="postCheckIn.title">Điểm danh</Translate>
                                        </ModalHeader>
                                        <ModalBody style={{ background: "gainsboro" }}>
                                            <Row>
                                                ...
                                                {this.state.checkinStatus === false ? (
                                                    <Col>
                                                        <b className="mt-4"><Translate id="postCheckIn.code">Mã điểm danh</Translate></b>
                                                        ...
                                                        <div className="item-right mt-3">
                                                            ...
                                                            >
                                                                <Translate id="postCheckIn.verify">Xác thực</Translate>
                                                            </Button>
                                                            <Button
                                                                color="danger"
                                                                onClick={this.toggleCheckin}
                                                            >
                                                                <Translate id="postCheckIn.exit">Thoát</Translate>
                                                            </Button>
                                                        </div>
                                                    </Col>
                                                ) : (
                                                        <Col>
                                                            <Alert color="primary">
                                                                <Translate id="postCheckIn.Mess1">Hôm nay bạn đã điểm danh rồi!!!</Translate>
                                                            </Alert>
                                                        </Col>
                                                    )}
                                            </Row>
                            ...
                            <Link to={`eventMore/${this.props._id}`}>
                                <Button color="success" className="mr-1 success p-2">
                                    <i className="fas fa-angle-double-right icon-button" /> <Translate id="postCheckIn.more">Xem thêm</Translate>
                                </Button>
                            </Link>
                        </div>
                    </Col>
...
const mapDispatchToProps = (dispatch) => ({
    levelUpUser: () => dispatch(userActions.levelUpUser())
})

export default withRouter(
    connect(
        mapStateToProps, mapDispatchToProps
    )(withLocalize(PostCheckin))
);
